...
export class MembercompanyproductsService {
  ...
  findByMembercompanyproductName(
    product_name: string,
  ...
  findByMembercompanyproductNumber(
  ...
  findByMembercompanyproductCompanycode(
    company_code: string,
  ): Promise<MembercompanyproductEntity[]> {
    return this.membercompanyproductsRepository.find({
      where: {
  ...
  async update(membercompanyproduct: UpdateMembercompanyproductDTO) {
    const resultMembercompanyproduct =
      await this.findByMembercompanyproductNumber(
    ...
    try {
      ...
      return await this.findByMembercompanyproductNumber(
        membercompanyproduct.product_number,
      );
    } catch (e) {
      console.log(
        'there is no product_number : ' + membercompanyproduct.product_number,
      );
      throw e;
    }
  }
